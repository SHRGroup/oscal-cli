...
ARG RELEASE=v0.3.0
RUN git clone --recurse-submodules -b ${RELEASENUM} https://github.com/usnistgov/oscal-cli.git  /oscal-cli/
...
ARG RELEASE=v0.3.0
RUN export RELEASENUM=$(echo $RELEASE | sed 's/v//g')
